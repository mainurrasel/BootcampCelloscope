...
// Shift and add the next letter - C
        packed = (packed << 16) | letterB;
// Shift and add the next letter - B
        packed = (packed << 16) | letterA;
// Shift and add the next letter - A
...
// Now unpack the letters and output them
        ...
        System.out.println(" " + letter + " 0x"+ toHexString(letter));// Shift out the rightmost letter
        packed >>= 16;
